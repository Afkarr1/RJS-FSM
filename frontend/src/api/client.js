...
export const techApi = {
  ...
  markPending: (id, reason) => api.post(`/tech/jobs/${id}/pending`, { reason }),
  resumeJob: (id) => api.post(`/tech/jobs/${id}/resume`),
  addProgress: (id, note) => api.post(`/tech/jobs/${id}/progress`, { reason: note }),
